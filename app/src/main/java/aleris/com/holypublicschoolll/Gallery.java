...
public class Gallery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new VViewAdapter(getSupportFragmentManager(), 3);
    ...
    public class VViewAdapter extends FragmentStatePagerAdapter {


        public VViewAdapter(FragmentManager fm, int tab) {
            super(fm);
        }
