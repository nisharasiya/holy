...
public class Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPresencesUtility=new SharedPresencesUtility( Student.this );
        ...
        if(sharedPresencesUtility!=null){
            userId=sharedPresencesUtility.getUserId(Student.this);
        }else{
            userId="1";
        }
        ...
        String pass;
        if(sharedPresencesUtility!=null){
            pass=sharedPresencesUtility.getPassword(Student.this);
        }else{
            pass="1";
        }

        new MyClassmateFetch().execute( "http://holygroup.aleriseducom.com/api/TCLASSDETAIL.aspx?user_name=" +userId+ "&password=" +pass);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                ListAdapter adapter = new SimpleAdapter(
                        Student.this, personList, R.layout.stu_list,
