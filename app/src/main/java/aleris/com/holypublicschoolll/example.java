...
//                new DownloadTask(Downloader.this,"http://holygroup.aleriseducom.com/AssignmentImages/"+homework);
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://holygroup.aleriseducom.com/AssignmentImages/"));
            PendingIntent pendingIntent = PendingIntent.getActivity(context, 0, new Intent(DownloadManager.ACTION_VIEW_DOWNLOADS), 0);
