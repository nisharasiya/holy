...
public class AttendanceTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPresencesUtility=new SharedPresencesUtility( AttendanceTeacher.this );
        ...
        if(sharedPresencesUtility!=null){
            ...
            userId=sharedPresencesUtility.getUserId(AttendanceTeacher.this);
        ...
        String pass;
        if(sharedPresencesUtility!=null){
            pass=sharedPresencesUtility.getPassword(AttendanceTeacher.this);
        }else{
            pass="1";
        }

        new AttendanceFetch().execute( "http://holygroup.aleriseducom.com/api/EMPATTENDANCE.aspx?user_name=" +userId+ "&password=" +pass );
    }
    ...
    private class AttendanceFetch extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog( AttendanceTeacher.this );
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                ListAdapter adapter = new SimpleAdapter(
                        AttendanceTeacher.this, personList, R.layout.att_lis,
                        new String[]{TAG_DATE, TAG_ATTENDANCE},
                        new int[]{R.id.dateAttendance, R.id.attendanceType}
